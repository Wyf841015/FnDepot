...
| 应用 | 版本 | 说明 |
|------|------|------|
| [日志哨兵](fnlogpush/) | v0.9.31 | 日志监控 + 多渠道推送 + 事件管理 |
...
| [视频下载器](fnytdlp/README.md) | v0.2.0 | 集成 yt-dlp (1872+ 站点)，自适应 x86_64/aarch64 双 binary，KPI Dashboard + SSE 实时进度 + 任务详情弹窗 + 下载路径浏览 + 多网站 Cookie |
...
**更新日志 (v0.9.31)**：
- 暗夜紫主题修复：ThemeManager.setTheme现在始终添加theme-xxx class
