...
**v0.3.1 新增：频道订阅**
- 表格化订阅管理（iOS 风格开关、每行独立检查/删除）
- 增量下载：lastId + 时间窗口双保险，只下载新内容
- 自动修复 lastId 失效（视频被删/下架）/多页列表重下/重复添加/URL 兜底重下等 5 类 bug
...
2. 启用应用，浏览器访问桌面图标
3. 首次进入"设置"，配置下载路径
4. 点 🔔 订阅按钮 → 添加 YouTube/B站频道自动监控下载
